...
func TestParseDomain(t *testing.T) {
	...
	tests := []struct {
		...
		{"json url", args{`{"url":"https://json.com"}`}, []*http.Target{{IsTLS: true, Hostname: "json.com", Port: 443}}, false},
		{"json host", args{`{"host":"json.com"}`}, []*http.Target{{IsTLS: true, Hostname: "json.com", Port: 443}, {Hostname: "json.com", Port: 80}}, false},
		{"json domain", args{`{"domain":"json.com"}`}, []*http.Target{{IsTLS: true, Hostname: "json.com", Port: 443}, {Hostname: "json.com", Port: 80}}, false},
		{"json ip", args{`{"ip":"127.0.0.1"}`}, []*http.Target{{IsTLS: true, Hostname: "127.0.0.1", Port: 443}, {Hostname: "127.0.0.1", Port: 80}}, false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
